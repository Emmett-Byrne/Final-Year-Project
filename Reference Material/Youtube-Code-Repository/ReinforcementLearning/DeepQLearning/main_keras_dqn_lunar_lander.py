...
if __name__ == '__main__':
    ...
    for i in range(n_games):
        ...
        while not done:
            action = agent.choose_action(observation) #action = whole number
            observation_, reward, done, info = env.step(action) #observations = array of elements between 0 and 1
